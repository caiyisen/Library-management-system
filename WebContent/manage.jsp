  	...
  	<table border="1" cellspacing="0" cellpadding="0" align="center">
  		...
  		<%for(int j=0;j<i;j++){ %>
  			<tr height="25" align="center">
 				...
 				<td id="td1"><a class="change" href='modify_paper.jsp?stuid=<%=pno[j]%>'>修改</a>   <a class="change" href='delete_paper.jsp?stuid=<%=pno[j]%>'>下架</a></td>
  			</tr>
  		<%} %>
  	</table>
  	<br>
  	<br>
  	<span id ="back"><a href='login.jsp'>返回登录界面</a>  <a href='add_paper.jsp'>新报纸上架</a></span>  <a href='manage_customer.jsp'>管理顾客</a></span> 
</body>
</html>